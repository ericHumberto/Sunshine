package com.udacity.eric_.sunshine.app.data;
...
//        // entry columns
    ...
    */
    public void testLocationTable() {
        ...
        Cursor cursor = cursor = db.query(WeatherContract.LocationEntry.TABLE_NAME, null, null, null, null, null, null);
        ...
        // query if you like)
        TestUtilities.validateCursor("Error", cursor, contentValues);
        cursor.close();
    }
    ...
    public void testWeatherTable() {
        ...
        // Insert ContentValues into database and get a row ID back
        Long wheaterRowId = db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, contentValues);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCursor("Errr", cursor, contentValues);
