package com.example.erics.sunshine.app.data;
...
public class TestDb extends AndroidTestCase {
    ...
    */
    public void testLocationTable() {
        ...
        long locationRowId = this.insertLocation(testValues);
    ...
    public void testWeatherTable() {
        ...
        long locationId = this.insertLocation(locationValues);
        ...
        Assert.assertEquals(db.insert(WeatherContract.WeatherEntry.TABLE_NAME, null, weatherValues), 1);
     ...
     */
    public long insertLocation(ContentValues testValues) {
        WeatherDbHelper dbHelper = new WeatherDbHelper(getContext());
        SQLiteDatabase db = dbHelper.getWritableDatabase();
